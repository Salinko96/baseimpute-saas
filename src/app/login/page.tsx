    ...
    <div className="flex min-h-screen items-center justify-center bg-gray-100">
      <div className="w-full max-w-md p-8 bg-white rounded-xl shadow-lg border">
        <div className="text-center mb-8">
          <h1 className="text-3xl font-bold text-gray-900">BaseImpute</h1>
        ...
        <div className="mt-6 text-center text-sm text-gray-600">
          Pas encore de compte ? <a href="/signup" className="text-blue-600 hover:underline font-medium">S'inscrire</a>
        </div>
      </div>
    </div>
  );
